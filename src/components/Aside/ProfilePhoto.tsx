...
const ProfilePhoto = () => {
  return (
    <>
      <div className="mx-auto my-2 overflow-hidden transition-all duration-700 rounded-full group w-52 h-52 x-auto lg:h-52 lg:w-52 lg:my-22 drop-shadow-4xl hover:rounded-md bg-gradient-to-br from-primary/40 to-primary/70">
        <img
