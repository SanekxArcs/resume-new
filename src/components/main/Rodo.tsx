...
const Rodo = () => {
  return (
    <div className="container px-4 mx-auto my-10 select-all">
      <a href="https://nofluffjobs.com/pl/log/praca-w-it/cv/klauzula-cv-2023-aktualna-wersja-niezbedna-przy-rekrutacjach/#:~:text=jest%20gotowa%20formu%C5%82a.-,Wyra%C5%BCam%20zgod%C4%99%20na%20przetwarzanie%20moich%20danych%20osobowych%20dla%20potrzeb%20niezb%C4%99dnych%20do,swobodnego%20przep%C5%82ywu%20takich%20danych%20oraz%20uchylenia%20dyrektywy%2095/46/WE%20(RODO)).,-Mo%C5%BCliwa%20jest%20r%C3%B3wnie%C5%BC">
<p className="text-xs pb-2 text-muted-foreground">I consent to the processing of my personal data as part of the recruitment process for the position I have applied for. I consent to the processing of my personal data contained in this application for the purpose of future recruitment by the company to which I have applied.</p>
